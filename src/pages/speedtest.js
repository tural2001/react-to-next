...
const Speedtest = () => {
  ...
  useEffect(() => {
    ...
    // Sayfa kapatıldığında veya yenilendiğinde active'i tekrar false yap
    window.addEventListener('beforeunload', () => {
      setActive(false);
    });

    return () => {
      // Komponent temizlendiğinde event listener'ı kaldır
  ...
  function getStrokeDashOffset(downloadSpeed) {
    const StrokeMap = [
      ...
      { downloadSpeed: 41, strokeDashoffset: '1530px' },
      { downloadSpeed: 42, strokeDashoffset: '1540px' },
      { downloadSpeed: 43, strokeDashoffset: '1550px' },
  ...
  return (
    <>
      ...
      <div className="w-full mx-0 bg-image">
        <div className="w-[1100px] h-[741px]  mx-auto flex gap-10 justify-between items-center  max-xl:hidden">
          ...
          <div className="flex flex-col justify-center items-center pl-10 py-10">
            <svg
              width="536"
              height="535"
              viewBox="0 0 536 535"
            ...
            >
              ...
              <path
                ...
                class="svg-elem-74"
              ></path>
              <foreignObject x="0" y="80%" width="100%" height="50%">
                <div xmlns="http://www.w3.org/1999/xhtml">
                  <p className="text-[64px]  text-white font-bold leading-[78px] flex flex-col justify-center items-center mb-10">
                    {data.downloadSpeed} <br />
            ...
            <button
              className="ti mt-10 bg-[#5B328C] hover:bg-[#3f2361] font-bold text-[#FFC75B] w-[251px] leading-[24px] h-[68px] text-[20px] rounded-[70px]"
              loading={loading ? 'true' : 'false'}
              onClick={() => {
                onSubmit(), toggleAnimation();
              }}
              style={{
                boxShadow:
                  '3.2741312980651855px 3.2741312980651855px 23.737451553344727px 2px #43256C, 0px 0px 0px 5px #43256C',
                borderColor: 'black',
                borderStyle: 'solid',
                borderWidth: '1px',
              }}
        ...
        <div className="hidden max-xl:flex max-xl:flex-col max-xl:gap-10 max-xl:justify-center max-xl:items-center">
          <div className="relative flex flex-col gap-10 mt-10 justify-center items-center"></div>
          <div className="flex flex-col gap-5 relative">
            <div className="">
              <svg
                width="606"
